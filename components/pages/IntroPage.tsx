...
export default function IntroPage({
  ...
  return (
    <div>
      <div className="relative left-1/2 -translate-x-1/2 w-[calc(100vw-16rem)] -mt-12 mb-6 overflow-hidden">
        {/* 배경 이미지 */}
        <div
          aria-hidden
        ...
        {/* 콘텐츠 */}
        <div className="relative px-12 pt-16 pb-14">
          <div className="max-w-4xl mx-auto">
            <div className="inline-flex items-center gap-2 px-3 py-1 bg-white/10 text-white/90 border border-white/25 backdrop-blur-sm rounded-full text-xs font-medium mb-8">
              <Sparkles className="w-3 h-3" />
              FDI 2026 Symposium · Track 5
            </div>
            <h1 className="font-display text-6xl md:text-7xl font-medium text-white tracking-tight leading-[1.05] mb-6 break-keep">
              Building
              <br />
              <span className="text-blue-300">AI Data Infrastructure</span>
            </h1>
            <p className="text-2xl font-display text-white/85 leading-snug max-w-2xl mb-10 italic break-keep">
              &quot;ChatGPT는 똑똑한데,
              <br />왜 우리 회사 일은 못 도와줄까?&quot;
            </p>
            <button
              onClick={() => onNavigate("challenge")}
              className="inline-flex items-center gap-2 bg-white hover:bg-slate-100 text-blue-700 px-6 py-3 rounded-lg font-medium transition-colors group shadow-lg"
            >
              학습 시작하기
